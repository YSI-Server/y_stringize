...
See [y_stringise](https://github.com/YSI-Server/y_stringise/blob/dev/readme.md)

[![sampctl](https://shields.southcla.ws/badge/sampctl-y_stringize-2f2f2f.svg?style=for-the-badge)](https://github.com/YSI-Server/y_stringize)
...
```bash
sampctl package install YSI-Server/y_stringize
```

Include in your code and begin using the library:

```pawn
#include <YSI-Server/y_stringize>
```

## Documentation

* [Quick Start](YSI-Server/y_stringize/quick-start.md) - One very simple example of getting started with this library.
* [Features](YSI-Server/y_stringize/features.md) - More features and examples.
* [FAQs](YSI-Server/y_stringize/faqs.md) - Frequently Asked Questions, including errors and solutions.
* [API](YSI-Server/y_stringize/api.md) - Full list of all functions and their meaning.
* [Internal](YSI-Server/y_stringize/internal.md) - Internal developer documentation for the system.
